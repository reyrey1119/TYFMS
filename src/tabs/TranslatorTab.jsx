...
const { user, supabaseEnabled, profile, saveProfile } = useAuth()
...
if (profile.mos) setMos(profile.mos)
...
{profileApplied && profile && (profile.branch || profile.rank || profile.mos) && (
<div style={{
...
<strong>Using your saved profile.</strong> Branch, rank, and MOS have been pre-filled from your account.
</p>
</div>
)}
