...
// Personalization: prefer the shared profile (mos/branch/rank), fall back to
// the legacy resume_drafts record for users who haven't re-saved a profile yet.
useEffect(() => {
