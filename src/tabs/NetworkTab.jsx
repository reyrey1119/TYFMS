...
export default function NetworkTab() {
  ...
  return (
    <div>
      ...
      <p className="sec-sub">
        Connect with veterans who share your MOS, AFSC, or rate. Mentors share what worked.
        Mentees get real guidance — not generic advice.
        {useDb && ' Profiles are shared across all TYFMS users.'}
      </p>

      <div className="insight" style={{ marginBottom: 24 }}>
        <p className="label">Why peer mentorship works</p>
        <p>
          Veterans who connected with a peer mentor during transition found civilian employment faster —
          because shared language (same MOS, same branch) cuts through months of confusion that no
          career center can bridge.
        </p>
      </div>
              ...
              >
                ...
                {link && (
                  ...
                  >
                    <button
                      style={{
                        padding: '5px 14px', background: '#1B3A6B', border: 'none',
            ...
            {(() => {
              ...
              return (
                <a href={link.href} target={link.external ? '_blank' : undefined} rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                  <button
                    style={{
                      width: '100%', padding: '11px', background: '#1B3A6B', border: 'none',
